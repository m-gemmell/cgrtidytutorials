...
[Tidyverse Dplyr page](https://cgr-liverpool.github.io/Tidyverse/dplyr/dplyr.html)
...
[Pipes webpage](https://cgr-liverpool.github.io/Tidyverse/dplyr/pipes.html)
...
As **tibbles** do not have row names (see [Tibble structures](https://cgr-liverpool.github.io/Tidyverse/tibble/structure.html)), column/variable names are frequently used in functions across `tidyverse` packages.
...
Thankfully when printing or [glimpsing](https://cgr-liverpool.github.io/Tidyverse/dplyr/glimpse.html) (covered later) a **tibble** it will show which columns need quotes.
...
-   [**`arrange()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/arrange.html): Arrange the rows of a **tibble**
    -   Can be used to reorder the rows based on the values of a column
-   [**`distinct()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/distinct.html): Extracts unique/distinct rows from a **tibble**
-   [**`filter()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/filter.html): Extract rows by filtering with conditions
    -   Can be used to pick rows of certain groups, filter based on numeric sizes, and more
-   [**`slice()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/slice.html): A set of methods to choose a slice of rows based on index positions, top and bottom observations, and min and max values based on a specific column
...
[Dplyr arrange() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/arrange.html)
...
[Dplyr distinct() webpage](https://cgr-liverpool.github.io/Tidyverse/dplyr/distinct.html)
...
[Dplyr filter() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/filter.html)
...
[Dplyr slice() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/slice.html)
...
-   [**`glimpse()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/glimpse.html): Print a **tibble** in a transposed manner
    -   Useful for seeing the data types of all the columns.
-   [**`mutate()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/mutate.html): Mutate columns to create new columns based on existing ones, modify existing columns, and delete columns
-   [**`pull()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/pull.html): Pull out a single column from a **tibble**, resulting in a **vector**
-   [**`relocate()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/relocate.html): Relocate columns
    -   You can relocate columns to the start or end, and you can move them after or before specified columns
-   [**`rename()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/rename.html): Rename columns in a **tibble**
-   [**`select()`**](https://cgr-liverpool.github.io/Tidyverse/dplyr/select.html): Select specific columns of a **tibble**
...
[Dplyr glimpse() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/glimpse.html)
...
[Dplyr select() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/select.html)

**Tip:** Use [the main dplyr page](https://cgr-liverpool.github.io/Tidyverse/dplyr/dplyr.html) to get an overview of all the `dplyr` functions.
...
```{r select-4-exercise, exercise=TRUE, exercise.eval=TRUE}
mushroom_tbl
```
...
```{r select-5-exercise, exercise=FALSE}
...
You can use operators and/or functions in a `mutate()` function with one or more columns/variables within the **tibble** you are mutating.

Read through and use the guidance in the below link to complete the challenges.

[Dplyr mutate() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/mutate.html)
...
[Dplyr pull() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/pull.html)
...
[Dplyr relocate() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/relocate.html)
...
[Dplyr rename() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/rename.html)
...
-   [Dplyr group_by() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/group_by.html)
-   [Dplyr count() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/count.html)
-   [Dplyr summarise() page](https://cgr-liverpool.github.io/Tidyverse/dplyr/summarise.html)
...
[Dplyr Bind tibbles page](https://cgr-liverpool.github.io/Tidyverse/dplyr/bind_tibbles.html)
